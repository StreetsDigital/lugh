...
import { IAssistantClient, MessageChunk, ApprovalContext } from '../types';
...
export class CodexClient implements IAssistantClient {
   ...
   * @param _approvalContext - Optional approval context (not used by Codex, for interface compatibility)
   */
  async *sendQuery(
    prompt: string,
    cwd: string,
