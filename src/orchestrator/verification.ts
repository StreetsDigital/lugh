...
export class VerificationEngine {
  constructor() {
    if (!isEnabled('EXTERNAL_VERIFICATION')) {
      throw new Error(
        '[VerificationEngine] EXTERNAL_VERIFICATION feature is not enabled. ' +
          'Set FEATURE_EXTERNAL_VERIFICATION=true (requires AGENT_POOL).'
      );
    }
  }
